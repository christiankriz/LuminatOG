define(["dojo/dom", "../widget/tabNavigation/tabNavigation", "dijit/registry", "dojox/mobile/ListItem",
	"dojox/gesture/tap", "dojo/_base/lang", "dojo/on", "../widget/EnterpriseHeader/EnterpriseHeader","../js/Transitioner",
	"dijit/Dialog", "dojo/_base/window", "dojox/mobile/Button", "../widget/headerBar/headerBar",
...
//			}else
		...
		_makeCall: function(href, dialog){
			...
			callLog.then(function(){
				...
				dialog.hide();
				var errDialog = new Dialog({title : "Cellular Call", content: "We could not connect to Luminet World please check you internet connectivity and try again.", class:"claro", daggable:false, style:{color: "black", border:"black 2px solid", textAlign:"center"}});
		...
		followEnterprise: function(event){
			...
			if(rels[0]){
				...
				promise.then(function(){
					...
					var dialog = new Dialog({title : "Cellular Call", content: "We could not connect to Luminet World please check you internet connectivity and try again.", class:"claro", daggable:false, style:{color: "black", border:"black 2px solid", textAlign:"center"}});
