 ...
 */
define(["dojo/_base/declare","dojo/Deferred", "dojo/promise/all" ,"dojo/request", "dojo/_base/lang", "dojo/json"],function(declare,Deferred,all,request,lang,json){
	return declare(null,{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
		userLogin: function(formData){
			...
			var promise = request.post(RUM.serverAddress + ":12014/getnodebyindex",
				{data: formDataString,
				handleAs: "json",
				preventCache: true,
				headers : {"X-Requested-With": ""}});
